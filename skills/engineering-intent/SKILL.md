...
- Read [references/documentation.md](references/documentation.md) when starting a project or milestone, creating or updating a blueprint, work specification, README, architecture document or diagram, ADR, REST API or OpenAPI contract, configuration reference, runbook, migration or release guide, generated reference, localized documentation, technical report, implementation-status record, or documentation verification.
