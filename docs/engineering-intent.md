...
This document records a reusable way of designing and delivering software. It deliberately avoids product architecture, repository layouts, service names, technology selections, ports, and current implementation status. Those belong to the system that owns them.
...
This document should remain opinionated enough to change decisions and general enough to apply without knowing which repository is open.
